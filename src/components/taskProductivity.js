  ...
  render() {
    return (
      <tr id={"row" + this.props.index}>
        ...
        <td id={"bilans" + this.props.index} style={{backgroundColor: this.state.greenBackgroundColor ? 'green' : 'red'}}>{this.state.greenBackgroundColor ? '-' : '+'} {this.taskProductivityLogic()}</td>
      </tr>
    );
  }
}